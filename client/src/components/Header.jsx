          ...
          <div className="container px-4 mx-auto">
            <div className="flex flex-wrap xl:items-center -mx-4">
              <div className="w-full md:w-1/2 px-4 mb-16 md:mb-0">
                ...
                <section id="home" className="container" style={{ backgroundColor: "rgb(0, 101, 219)", background: "linear-gradient(90deg, rgb(0,101,219) 50%, rgba(0,212,255,1) 100%)", minHeight: "90px" }}>
                  <div className="conatiner">
                    <div className="row justify-content-center">
                      <div className=""></div>
                      <h1 className="display-4  text-white fw-bolder mb-4 text-center">
                  Save Time and Money with the Budget Tracker!
                </h1>
                <p className="lead text-center fs-4 mb-5 text-white">
                "Every penny counts. Keep a close eye on your expenses with our app."
                </p>
